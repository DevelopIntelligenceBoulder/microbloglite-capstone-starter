...
function buildUserPostsCard(posts) {
    for (let post of posts) {
        ...
        svg.setAttribute("class", "bi bi-hand-thumbs-up");
        svg.setAttribute("viewBox", "0 0 16 16");
        svg.setAttribute("onclick", "handleClick()");
...
function handleClick(svg) {
    ...
    if (likeButton) {
        svg.setAttribute("fill", "red"); //red on like 
    } else {
        svg.setAttribute("fill", "currentColor"); //color unlike back to none
    }
