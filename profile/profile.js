        ...
        <div class="flex">
            <div class="w-full">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1 text-center py-2 m-2">
                        <a href="#" class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300  click:bg-red-500">
